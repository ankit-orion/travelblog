...
<section className="bg-gray-800 text-gray-100 h-screen">
  <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between h-full">
    <div className="flex items-center justify-center p-6 mt-8 lg:mt-0 sm:h-80 lg:h-full xl:h-full 2xl:h-full">
      <img src="https://www.pngkey.com/png/full/217-2174579_picture-royalty-free-stock-images-clip-art-real.png" alt="" className="object-cover h-full w-auto sm:h-96 lg:h-full xl:h-full 2xl:h-full flex-shrink-0" />
    </div>
